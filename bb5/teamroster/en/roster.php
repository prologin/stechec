...
<HTML>
<HEAD>
<TITLE>Team editor for Tow Bowl Tactics</TITLE>
...
<BODY BACKGROUND="http://toweld.free.fr/towbowltactics/img/bg.jpg" <? if( !$r ) echo "onLoad='preloadimages()'" ?> >
<CENTER><IMG SRC="http://toweld.free.fr/towbowltactics/img/title_marbre.gif" WIDTH="320" HEIGHT="113" BORDER=0 ALT="Tow Bowl -Tactics-"></CENTER>
...
Please, use this page to create<br> 
teams in XML, directly usable in<br> 
Tow Bowl Tactics...<br>
<br>
Toweld, 30 august 2002<br>
</font>
</td>
...
<font class="text">Choose the race of team : </font>
...
<input type="hidden" name="editable" value="<?= $editable?>">
  <table border="1" cellspacing="0" cellpadding="1" bgcolor="#FFFFEE" bordercolor="#BBBBBB" width="800">
    <tr align="center" valign="middle"> 
      ...
      <td><font class="titre"><b>COMP</b></font></td>
...
?>	
	  ...
	  <br><input type="button" value="Change" name="btn_changer_image" class="bouton" onClick="popup_embleme('<?= $filename ?>');">
	  </td>
    ...
    <tr> 
      <td colspan="7" valign="middle" align="center"><input type="hidden" name="dl_xml" value="0"><input type="button" name="voir_btn" value="View xml" class="bouton" onClick="document.feuille.dl_xml.value=0;generer_xml();">&nbsp;<input type="button" name="xml_btn" value="Download xml" class="bouton" onClick="document.feuille.dl_xml.value=1;generer_xml();">&nbsp;<input type="button" name="html_btn" value="Printable version" class="bouton" onClick="version_imprimable();"></td>
      <td colspan="7" valign="middle" align="right"><font class="titre"><input type="button" name="btn_calc_total" value="Calculate" onClick="calculer_total_equipe();" class="bouton">&nbsp;&nbsp;&nbsp;<b>Total 
...
<br>
<br>
<pre>At this time, you can also configure 
your formations...</pre>
<input type="button" name="edit_formation_btnl" value="Formation Editor" onClick="open_editeur_formation();" class="bouton">
<?
	}
else {
?>
<br>
<br>
<pre>At this time, you can also <a href="formations.html" target="_blank">configure 
your formations</a>...</pre>
...
<A HREF="http://toweld.free.fr/towbowltactics/index_en.html">BACK</A>
<HR>
<CENTER>
  <A HREF="mailto:toweld@wanadoo.fr?subject=TBT TEAM ROSTER">Toweld</A> - 10 aout 2002 
</CENTER> 
