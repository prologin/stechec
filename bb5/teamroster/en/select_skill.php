...
<TR>
	...
	<font size="1" face="Arial, helvetica, sans-serif">Player Skills</font><br>
	...
	<TD align="center" width="140">
	<font size="1" face="Arial, helvetica, sans-serif">Possible -><script language="Javascript">document.write('('+skills[<?= $p ?>]+')');</script></font><br>
...
<TR>
	<TD align="center" colspan="3"><input type="button" name="close_btn" value="Validate" onClick="save_and_close();" class="bouton"></TD>
</TR>
</TABLE>
</form>
</center>
