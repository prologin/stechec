...
<HTML>
<HEAD>
<TITLE>Editeur d'équipe pour Tow Bowl Tactics - Version imprimable</TITLE>
<META NAME="Author" CONTENT="toweld(at)free.fr">
...
window.onafterprint = 
  function () {
	input_td.innerHTML = '<input  type="button" name="Imprimer_btn" value="Imprimer la feuille" class="bouton" onClick="imprimer();">&nbsp;<input  type="button" name="close_btn" value="Fermer la fenêtre" class="bouton" onClick="window.close();">';
  };
...
?>	
      ...
      <td align="right" valign="middle"><font class="titre"><?= $cout_rel_v ?></font></td>
    </tr>
    <tr> 
      ...
      <td align="right" valign="middle"><font class="titre"><?= $cout_pop_v ?></font></td>
    </tr>
    <tr> 
      <td colspan="3" align="right" valign="middle"><font class="titre">Classement&nbsp;</font></td>
      <td colspan="4"><font class="titre"><?= $cla_v ?></font></td>
      ...
      <td valign="middle" align="center"><font class="titre">X</font></td>
      <td colspan="2" nowrap align="right"><font class="titre">10000 PO&nbsp;</font></td>
      <td align="right" valign="middle"><font class="titre"><?= $cout_ass_v ?></font></td>
    </tr>
    <tr> 
      ...
      <td valign="middle" align="center"><font class="titre">X</font></td>
      <td colspan="2" nowrap align="right"><font class="titre">10000 PO&nbsp;</font></td>
      <td align="right" valign="middle"><font class="titre"><?= $cout_ppg_v ?></font></td>
    </tr>
    <tr> 
      <td colspan="3" valign="middle" align="right"><font class="titre">Nom de l'&eacute;quipe&nbsp;</font></td>
      ...
      <td align="right" valign="middle" ><font class="titre"><?= $cout_apo_v ?></font></td>
    </tr>
    <tr> 
      <td colspan="7" valign="middle" align="center" name="input_td" id="input_td"><input  type="button" name="Imprimer_btn" value="Imprimer la feuille" class="bouton" onClick="imprimer();">&nbsp;<input  type="button" name="close_btn" value="Fermer la fenêtre" class="bouton" onClick="window.close();"></td>
      <td colspan="7" valign="middle" align="right"><font class="titre">&nbsp;<b>Co&ucirc;t 
        total de l'&eacute;quipe&nbsp;</b></font></td>
	  <td align="right" valign="middle"><font class="titre"><?= $cout_eq_v ?></font></td>
    </tr>
  </table>
