...
trop monolithique, liée à un manque de documentation chronique, a dû
pas mal freiner le dev. L'objectif, dans un premier temps, est de
...
\item \texttt{player\_id}: L'uid du client duquel le message provient
