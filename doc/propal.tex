...
joueurs en , mais souffre de quelques défauts. Le graphisme est assez
austère, et les versions actuelles ne sont pas \emph{open source}, ce
qui rend plus difficile l'ajout d'extensions\footnote{Un problème
majeur: le développeur, SkyJunkie, ne semble pas souhaiter pas
intégrer les règles du LRB5, ce qui va surement fruster beaucoup de
joueurs.}. L'objectif\footnote{Ce que l'on espère, il n'est pas dit que
ca marchera :)} à long terme de \ac{tbt} est de combler ce trou, en
proposant une adaptation de Blood Bowl libre, jolie, extensible, en
essayant le plus possible de respecter le jeu plateau.
...
vraiment bien définies, ce qui rend la chose plus compliquée (mais ne
