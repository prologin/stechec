...
//
__internal__cxx__position api_pos_renfort(bool ennemi);

///
// Renvoie les caractéristiques d'un type d'unité.
//
__internal__cxx__caracs api_caracteristiques(type_unite tu);

///
// Retourne une structure "cartes" contenant les informations sur les cartes que vous avez en main.
//
__internal__cxx__cartes api_mes_cartes();
...
//
__internal__cxx__taille_terrain api_taille_terrain_actuelle();

///
// Utilise une carte « Potion magique » que vous avez dans votre main.
//
erreur api_potion(__internal__cxx__position cible);

///
// Utilise une carte « Déguisement » que vous avez dans votre main.
//
erreur api_deguisement(__internal__cxx__position cible, type_unite nouveau_type);

///
// Utilise une carte « Banzaï » que vous avez dans votre main.
//
erreur api_banzai(__internal__cxx__position cible);
...
//
erreur api_relever(__internal__cxx__position cible);

///
// Attaque une autre unité.
//
erreur api_attaquer(__internal__cxx__position attaquant, __internal__cxx__position cible);
...
//
void api_afficher_taille_terrain(__internal__cxx__taille_terrain v);

///
// Affiche le contenu d'une valeur de type caracs
//
void api_afficher_caracs(__internal__cxx__caracs v);
...
//
void api_afficher_cartes(__internal__cxx__cartes v);
