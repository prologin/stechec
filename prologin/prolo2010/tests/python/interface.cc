...
taille_terrain lang2cxx<PyObject*, taille_terrain>(PyObject* in)
{
  ...
  i = PyObject_GetItem(in, i);
  if (i == NULL) throw 42;
  out.taille = lang2cxx<PyObject*, int>(i);
  Py_DECREF(i);
  i = cxx2lang<PyObject*, int>(1);
  i = PyObject_GetItem(in, i);
  if (i == NULL) throw 42;
  out.min_coord = lang2cxx<PyObject*, int>(i);
  Py_DECREF(i);
  i = cxx2lang<PyObject*, int>(2);
  i = PyObject_GetItem(in, i);
  if (i == NULL) throw 42;
  out.max_coord = lang2cxx<PyObject*, int>(i);
  Py_DECREF(i);
  return out;
}
...
caracs lang2cxx<PyObject*, caracs>(PyObject* in)
{
  ...
  i = PyObject_GetItem(in, i);
  if (i == NULL) throw 42;
  out.pa_init = lang2cxx<PyObject*, int>(i);
  Py_DECREF(i);
  i = cxx2lang<PyObject*, int>(1);
  i = PyObject_GetItem(in, i);
  if (i == NULL) throw 42;
...
unite lang2cxx<PyObject*, unite>(PyObject* in)
{
  ...
  i = PyObject_GetItem(in, i);
  if (i == NULL) throw 42;
  out.ennemi = lang2cxx<PyObject*, bool>(i);
  Py_DECREF(i);
  i = cxx2lang<PyObject*, int>(2);
  i = PyObject_GetItem(in, i);
  if (i == NULL) throw 42;
  out.type_unite_actuel = lang2cxx<PyObject*, type_unite>(i);
  Py_DECREF(i);
  i = cxx2lang<PyObject*, int>(3);
  i = PyObject_GetItem(in, i);
  if (i == NULL) throw 42;
  out.vrai_type_unite = lang2cxx<PyObject*, type_unite>(i);
  Py_DECREF(i);
  ...
  i = PyObject_GetItem(in, i);
  if (i == NULL) throw 42;
  out.attaques = lang2cxx<PyObject*, int>(i);
  Py_DECREF(i);
  i = cxx2lang<PyObject*, int>(7);
  i = PyObject_GetItem(in, i);
  if (i == NULL) throw 42;
  out.attaques_gratuites = lang2cxx<PyObject*, int>(i);
  Py_DECREF(i);
...
cartes lang2cxx<PyObject*, cartes>(PyObject* in)
{
  ...
  i = PyObject_GetItem(in, i);
  if (i == NULL) throw 42;
  out.potion = lang2cxx<PyObject*, int>(i);
  Py_DECREF(i);
  i = cxx2lang<PyObject*, int>(1);
  i = PyObject_GetItem(in, i);
  if (i == NULL) throw 42;
  out.deguisement = lang2cxx<PyObject*, int>(i);
  Py_DECREF(i);
  i = cxx2lang<PyObject*, int>(2);
  i = PyObject_GetItem(in, i);
  if (i == NULL) throw 42;
  out.banzai = lang2cxx<PyObject*, int>(i);
  Py_DECREF(i);
  i = cxx2lang<PyObject*, int>(3);
  i = PyObject_GetItem(in, i);
  if (i == NULL) throw 42;
  out.pacifisme = lang2cxx<PyObject*, int>(i);
  Py_DECREF(i);
  return out;
}
