...
\def\ptitle{L'Arm\'ee des toons} %% Subject's main title
\def\psubtitle{Tu jouais encore aux billes que je commandais des toons dans la l\'egion} %% Subject's sub title
