...
*/
extern int taille_carte_x(void);

/*!
** Renvoie la hauteur de la carte
*/
extern int taille_carte_y(void);
...
*/
extern int distance(int x1, int y1, int x2, int y2, int sort_tranchee);
