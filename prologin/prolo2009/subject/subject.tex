...
\section{Introduction}
  ...
  \subsection{Le rouble, une monnaie forte !}
    ...
    précédentes missions, c'est à dire ARGENT\_INITIAL\footnote{cf API} roubles.
  ...
  \subsection{Chacun mon tour}
    ...
    corruption afin jouir du privilège d'agir seul dans la troisième et
    dernière phase.
...
\section{Phase I} % Construction des routes, ordre des joueurs
  ...
  \subsection{Constructions}
    ...
    \subsubsection{Architecture}
      ...
      vous n'échappez pas à la règle malgré les nombreux dessous de table
