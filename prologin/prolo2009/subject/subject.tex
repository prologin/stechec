...
\section{Phase III} % Placement des monuments, valeur des terrains
  ...
  \subsection{Intérêt des bâtiments spéciaux}
    ...
    Certains bâtiments possèdent un préstige négatif, diminuant ainsi la valeur
...
\section{Autres actions}
  ...
  \subsection {Vente}
    ...
    qui vous appartient et ainsi récuperer un nombre de roubles égal à la
  ...
  \subsection {Réservation}
    ...
    Durant la phase I vous avez la possibilité de reserver une case en payant
...
\section{Happy end}
  ...
  \subsection{Score}
    Le score d'un joueur sur une partie correspond à sa somme d'argent possédé
    plus la valeur de chaque maison qu'il détient.

    Pour le championnat, le premier gagne 3 points, le deuxième 1 et le dernier
    n'en gagne aucun. Si deux joueurs sont premiers ex-æquo ou si les trois
    joueurs ont le même score, ils n'ont aucun point.
