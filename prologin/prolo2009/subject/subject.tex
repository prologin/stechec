...
\section{Introduction}
  ...
  \subsection{Votre mission}
    Votre mission, que vous acceptez, est de construire, de faire
    fructifier et, surtout, de prendre le pouvoir de la ville dans
  ...
  \subsection{Chacun mon tour}
    ...
    corruption afin de jouir du privilège d'agir seul dans la troisième et dernière
    phase.

    \subsubsection{Ordre des joueurs}
      Chaque tour est donc composé de 3 phases. Chacun des joueurs jouera
      successivement la phase I avec les éventuelles constructions et
      destructions faites par les joueurs ayant agi avant lui. Lors de la phase
      II, les participants jouent cette fois de façon simultanée.\\
